...
},{"./model":"dEDha","./styles/style.css":"cy7Le","./classes/app":"g9LQJ"}],"dEDha":[function(require,module,exports) {
...
const model = [
    new (0, _blocks.TitleBlock)("Конструктор сайтов на чистом JavaScript ", {
        tag: "h2",
        styles: {
    ...
    new (0, _blocks.ImageBlock)((0, _photoJpgDefault.default), {
        styles: {
            padding: "2rem 0",
            display: "flex",
    ...
    new (0, _blocks.TextBlock)("Здесь моя работа с классами на чистом JavaScript, в дальнейшем буду дополнять его и улучшать", {
        styles: {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./classes/blocks":"gMfMj","./assets/photo.jpg":"U6kPt"}],"gkKU3":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"U6kPt":[function(require,module,exports) {
module.exports = require("c345705bfb66703d").getBundleURL("bLxZJ") + "photo.b1666a9c.jpg" + "?" + Date.now();

},{"c345705bfb66703d":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}],"cy7Le":[function() {},{}],"g9LQJ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
